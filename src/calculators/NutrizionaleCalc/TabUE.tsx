...
export function TabUE({ p, ue, specificGravity, selectedOptionals, showOptionals, activeSubTab }: TabUEProps) {
    ...
    const rows: UERow[] = [
        ...
        { label: 'di cui acidi grassi monoinsaturi', indent: true, value: `${rUE_sat(scaled.monoins)} g`, arPct: '—', isOptional: true, optionalKey: 'monoins' as keyof SelectedOptionals },
        { label: 'di cui acidi grassi polinsaturi', indent: true, value: `${rUE_sat(scaled.polins)} g`, arPct: '—', isOptional: true, optionalKey: 'polins' as keyof SelectedOptionals },
        ...
        { label: 'di cui polioli', indent: true, value: `${rUE_macro(scaled.polioli)} g`, arPct: '—', isOptional: true, optionalKey: 'polioli' as keyof SelectedOptionals },
        { label: 'di cui amido', indent: true, value: `${rUE_macro(scaled.amido)} g`, arPct: '—', isOptional: true, optionalKey: 'amido' as keyof SelectedOptionals },
