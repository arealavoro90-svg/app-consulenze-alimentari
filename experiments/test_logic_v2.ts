...
console.log('--- Prova Validazione Motore v2 (ESM) ---');
...
regions.forEach(reg => {
    ...
    if (reg === 'CANADA') {
        console.log(`  Nota Canada: Grassi > 5g devono essere arrotondati all'intero (25.0 -> 25)`);
    } else {
        console.log(`  Nota ${reg}: Grassi standard -> 25.0`);
    }
