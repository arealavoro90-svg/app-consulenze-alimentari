...
- Arrotondamento regionale: inline nei componenti `Tab*.tsx`, NON in un modulo separato
- `src/engines/nutritionalEngine.ts` e `src/logic/localizationModule.ts` **rimossi** — non esistono, non cercarli
